# New datasource for static assets, used by GitHub for their developer API site
# See: https://github.com/github/developer.github.com/blob/master/lib/static.rb
