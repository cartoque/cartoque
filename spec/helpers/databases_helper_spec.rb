...
describe DatabasesHelper do
  ...
  describe "#databases_summary" do
    it "returns empty string if databases list is empty" do
      assert_equal "", databases_summary([])
    end

    it "returns databases where size >= total_size / 6" do
    ...
    it "returns first two databases if none is greater than total_size / 6" do
