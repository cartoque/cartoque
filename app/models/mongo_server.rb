class MongoServer
  ...
  #TODO: has_many :exported_disks, class_name: "NetworkDisk", dependent: :destroy
  #TODO: has_many :network_filesystems, class_name: "NetworkDisk", foreign_key: "client_id", dependent: :destroy
